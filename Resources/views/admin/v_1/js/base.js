...
$(document).ready(function () {
    ...
    var table = $(".data-table").DataTable({
        ...
        fnInitComplete: function fnInitComplete(settings) {
    ...
    var hidden_table = $(".hidden-table").dataTable({
        buttons: [{ extend: 'print', className: 'btn dark btn-outline' }, { extend: 'copy', className: 'btn red btn-outline' }, { extend: 'pdf', className: 'btn green btn-outline' }, { extend: 'excel', className: 'btn yellow btn-outline ' }, { extend: 'csv', className: 'btn purple btn-outline ' }, { extend: 'colvis', className: 'btn dark btn-outline', text: 'Columns' }]
    });
        ...
        methods: {
            ...
            removeComponent: function removeComponent(index) {
                if ($(".description").length > 0) {
                    if (CKEDITOR.instances['description_' + index]) CKEDITOR.instances['description_' + index].destroy(true);
                }
