...
<head>
  ...
  {{Html::style(module_asset_url('core:resources/views/admin/'.$theme_cms->value.'/public/css/base.css').'?id='.filemtime(module_asset_path('core:resources/views/admin/'.$theme_cms->value.'/public/css/base.css')))}}
