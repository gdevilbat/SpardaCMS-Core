                                    ...
                                    <div class="col">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                <button class="dropdown-item confirm-delete" type="button"><a class="m-link m-link--state m-link--danger" data-toggle="modal" href="#small"><i class="fa fa-trash"> Delete</i></a></button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
