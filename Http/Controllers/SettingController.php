...
class SettingController extends CoreController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(action('\Gdevilbat\SpardaCMS\Modules\Core\Http\Controllers\SettingController@create'))->with('global_message',['status' => 400, 'message' => 'Success To Update Setting']);
    }
